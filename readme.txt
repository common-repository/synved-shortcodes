...
Tags: shortcode, links, author, button, plugin, Post, jquery, image, thumbnail, user, page, widget, list, shortlinks, media
...
1. This is the Shortcodes Editor that pops up in the edit post interface
2. Another example of the Shortcodes Editor 
3. An example of creating tabs with the shortcodes and the [SlickPanel skin](http://synved.com/product/wordpress-shortcodes-slickpanel-skin/)
4. An example of creating sections with the shortcodes and the [SlickPanel skin](http://synved.com/product/wordpress-shortcodes-slickpanel-skin/)
5. An example of creating message boxes with the shortcodes and the [SlickPanel skin](http://synved.com/product/wordpress-shortcodes-slickpanel-skin/)
6. An example of a user link shortcode customized as an author card or "vcard"
7. Same as the above but using the [SlickPanel skin](http://synved.com/product/wordpress-shortcodes-slickpanel-skin/)
8. How the [SlickPanel skin](http://synved.com/product/wordpress-shortcodes-slickpanel-skin/ "Transform the look of many elements in the Shortcodes plugin!") will transform the look of the shortcodes
